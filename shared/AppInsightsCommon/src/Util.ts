...
import {
    IDiagnosticLogger, IPlugin, arrForEach, arrIndexOf, attachEvent, canUseCookies as coreCanUseCookies, dateNow,
    ...
    newId, random32, setCookie as coreSetCookie, strTrim, toISOString, uaDisallowsSameSiteNone
